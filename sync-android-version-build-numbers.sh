...
version_code=$(/usr/libexec/PlistBuddy -c "Print CFBundleVersion" ${PATH_TO_PLIST})
version_name=$(/usr/libexec/PlistBuddy -c "Print CFBundleShortVersionString" ${PATH_TO_PLIST})
